...
const NAV_GROUPS: NavGroup[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { key: 'loan-analyst', label: '5. Analyst Structuring', icon: FileSearch, permission: 'loanAnalyst' },
      { key: 'loan-risk', label: '7. CRO Risk Assessment', icon: AlertTriangle, permission: 'loanRisk' },
      { key: 'loan-cfo', label: '8. CFO Liquidity Review', icon: Banknote, permission: 'loanCfoReview' },
      { key: 'loan-md', label: '10. MD Executive Approval', icon: Gavel, permission: 'loanMcc' },
      { key: 'loan-finalization', label: '12. HOC Go-Live', icon: FileCheck, permission: 'loanFinalization' },
      { key: 'loan-disbursement', label: '13. CFO Disbursement', icon: Wallet, permission: 'loanDisbursement' },
    ],
  },
  {
    id: 'portfolio',
